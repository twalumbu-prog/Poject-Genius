      ...
      messages = [
        {
          ...
          content: "You are an expert examiner grading a student's handwritten test script.\n" +
            ...
            "- BUBBLES CONTAIN LETTERS: Each circular bubble has a small pre-printed letter (A, B, C, D) inside it.\n" +
            "- WHAT COUNTS AS SHADED (MARK AS STUDENT ANSWER):\n" +
            "  * SOLID BLACK/DARK: The bubble is filled so dark that the pre-printed letter is NO LONGER VISIBLE. This is the highest confidence mark.\n" +
            "  * CROSS (X) or TICK (✔): There is a clear pen/pencil mark over the letter.\n" +
            "  * SCRIBLED: The letter is obscured by rough shading.\n" +
            "- WHAT IS NOT SHADED (IGNORE):\n" +
            "  * CLEAR LETTER: The pre-printed letter (A/B/C/D) is clearly visible and crisp with no pen marks over it.\n" +
            "  * LIGHT SHADOWS: Slight greyish tints that do not obscure the letter's sharp edges.\n" +
            "- RAW VISION: You are looking at a raw camera photo. Perspective and shadows exist. Use the PRINTED NUMBER on the left as your absolute anchor for the row.\n\n" +
